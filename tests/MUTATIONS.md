...
| `lapse_unbounded` | A version's lapse taken any distance out, so a mandate naming a co-signer nobody holds binds every label of its household until the year 9999 (§16.1, clause 58, decided 2026-09-19 after the first refutation pass over question 68) | Isolated run 2026-09-19: caught by 1 conformance probe, `permissions: ... > a mandate lapses at most a year after it is recorded (§16.1, clause 58)`, and 1 engine unit test, `lapse > a household that has lost its co-signer is held for at most a year` |
