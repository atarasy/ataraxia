...
| `canonical_form_without_carriage` | The carriage leaves the bytes a household signs (§6.5, question 40), so the one item 法11条1号 puts beside the price is outside what was agreed. Named one character from the row above until 2026-09-13, when they were told apart: that one breaks the hub's statement surface, this one the canonical form both sides compute | 13 |
