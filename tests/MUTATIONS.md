...
| `gift_ceiling_is_the_recipients` | A gift's daily ceiling read from the recipient's mandate while the giver pays (§12, §16.3, question 60) | Isolated run 2026-09-19: caught by 2 engine unit tests |
...
| `zero_settle_meets_the_ceiling` | A settlement of nothing refused on a day already past the ceiling, trapping a set that owes nothing behind its reserve (§16.3, question 62) | Isolated run 2026-09-19: caught by 1 engine unit test |
